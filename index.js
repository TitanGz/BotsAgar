/* Url: https://repl.it/@jimboy3100/agario-bots13
 Websocket: wss://agario-bots13--jimboy3100.repl.co
        ...
        switch (reader.readUint8()) {
            case 0:
                if (!user.startedBots) {
                    ...
                    bots.name = "OwnerDolbaeb"
                    bots.amount = 125
                    dataBot.connect()
                    let index = 0
                    startBotsInterval = setInterval(() => {
                        if (connectedBots < bots.amount && !stoppingBots) userBots.push(new Bot())
                    }, 500)
